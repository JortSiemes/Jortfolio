document.addEventListener("DOMContentLoaded", function () {
  ...
  if (checkArticleARead === "true" && checkArticleBRead === "true") {
    ...
    if (!localStorage.getItem("thank_you_shown")) {
      alert("Bedankt voor je deelname aan mijn onderzoek! De antwoorden zijn opgeslagen. -Jort, voor surveycircle: Redeem Survey Code with one click: https://www.surveycircle.com/FZYW-GF9J-X66U-PTZ6/ or https://surveyswap.io/sr/Y205-UX1O-6QH7");
